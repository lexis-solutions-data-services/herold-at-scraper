"""
Example: How to call the herold-at-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/herold-at-scraper
...
def run_actor():
    """Run the herold-at-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/herold-at-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.herold.at/gelbe-seiten/suche/?term=ATV Immobilien"}],
            "keyword": "ATV Immobilien",
            "maxItems": 10,
